    ...
    var body: some View {
        VStack {
            ...
            Text("forêt virtuelle")
                ...
                .padding(.bottom, 10)
                .offset(y: -40)
            JustifiedTextView(text: "Chaque fois que vous relevez un défi, vous plantez et entretenez un arbre virtuel. Regardez votre forêt prospérer à mesure que vous atteignez vos objectifs et vos jalons.")
                .frame(height: 120)
                .padding(.horizontal, 30)
                .offset(y: -20)
            JustifiedTextView(text: "Visualisez vos progrès : Votre forêt virtuelle est le reflet de votre dévouement et de votre croissance.")
                .frame(height: 70)
                .padding(.horizontal, 30)
                .offset(y: -20)
            HStack(spacing: 200) {
